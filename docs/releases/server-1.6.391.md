# PastureStack Server v1.6.391

Server v1.6.391 embeds Orchestration Engine `0.183.288` and Web Console
`1.6.94`. It keeps the compact resource menus, first-sample chart rendering,
calendar-month and all-time quick ranges, and localized Labels tab from
v1.6.390 while fixing explicit all-time audit-log queries across route refresh.
...
- An explicit audit-log all-time selection now remains unbounded after route
