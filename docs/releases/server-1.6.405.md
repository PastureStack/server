# PastureStack Server v1.6.405

This release keeps the reviewed Web Console, Compose Executor, catalog, and
runtime base from v1.6.404 and advances only the pinned Orchestration Engine.

## Operator-visible result

- Service creation and upgrade now preserve the selected Docker restart policy
  instead of silently replacing it with `no` before container creation.
...
- Orchestration Engine `0.183.291` from immutable first-party release
  `v0.183.291`, signed source commit
  `5e3e566eff15478f8ba77799fa8a73c18f61e4c7`, artifact SHA-256
  `2dd6d0637df1fd5e8fc7cafd184f0048ec9ff4b81ac0211f09ab935de0e19615`.
...
The engine regression test and complete dependent Maven reactor pass. The
Server publication workflow still requires source gates, initial and restart
smoke tests, a merged-rootfs vulnerability and secret scan, SBOM, provenance,
