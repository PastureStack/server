...
embedded Web Console with the reviewed `.33` artifact. It supersedes
`v1.6.320`, whose Web Console runtime was not suitable for deployment.

## Runtime change

- Base image: `ghcr.io/pasturestack/server:v1.6.319`
- Runtime image: `ghcr.io/pasturestack/server:v1.6.321`
- Orchestration Engine: `0.183.272`, built with Java `25`
- Authentication Service: `0.2.5`, built with Go `1.26.5`
- Web Console: `1.6.56-pasturestack.33`
...
The Web Console restores Ember NativeArray compatibility, attaches inherited
pod templates to their component classes, loads locale JSON through the current
Fetch response contract, and always dismisses the initial loading overlay after
...
The exact release source passed 266 Chromium tests. Two clean production builds
...
- Web Console source:
  `089adeeb2af2b4ca2caec603bb37a80a3b4f339c`
- Web Console artifact SHA-256:
  `d32f9a1a04816b6792028bd7f7f1e69a578dbec694b62c5c3edc6e31220d5a51`

## Release acceptance requirements

- All 266 Web Console browser tests, locale and ICU checks, source gates, and
...
- The formal endpoint must remain on `v1.6.319` until an isolated `v1.6.321`
