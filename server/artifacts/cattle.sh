...
setup_cli_artifact_overrides()
{
    ...
    local compose_version="${CATTLE_RANCHER_COMPOSE_VERSION:-v0.12.5}"
    local cli_version="${CATTLE_RANCHER_CLI_VERSION:-v0.6.14}"

    export CATTLE_RANCHER_COMPOSE_VERSION="$compose_version"
    export DEFAULT_CATTLE_RANCHER_COMPOSE_LINUX_URL="${DEFAULT_CATTLE_RANCHER_COMPOSE_LINUX_URL:-${artifact_base}/compose/${compose_version}/rancher-compose-linux-amd64-${compose_version}.tar.gz}"
    export DEFAULT_CATTLE_RANCHER_COMPOSE_DARWIN_URL="${DEFAULT_CATTLE_RANCHER_COMPOSE_DARWIN_URL:-${artifact_base}/compose/${compose_version}/rancher-compose-darwin-amd64-${compose_version}.tar.gz}"
    export DEFAULT_CATTLE_RANCHER_COMPOSE_WINDOWS_URL="${DEFAULT_CATTLE_RANCHER_COMPOSE_WINDOWS_URL:-${artifact_base}/compose/${compose_version}/rancher-compose-windows-386-${compose_version}.zip}"

    export CATTLE_RANCHER_CLI_VERSION="$cli_version"
    export DEFAULT_CATTLE_RANCHER_CLI_LINUX_URL="${DEFAULT_CATTLE_RANCHER_CLI_LINUX_URL:-${artifact_base}/cli/${cli_version}/rancher-linux-amd64-${cli_version}.tar.gz}"
    export DEFAULT_CATTLE_RANCHER_CLI_DARWIN_URL="${DEFAULT_CATTLE_RANCHER_CLI_DARWIN_URL:-${artifact_base}/cli/${cli_version}/rancher-darwin-amd64-${cli_version}.tar.gz}"
    export DEFAULT_CATTLE_RANCHER_CLI_WINDOWS_URL="${DEFAULT_CATTLE_RANCHER_CLI_WINDOWS_URL:-${artifact_base}/cli/${cli_version}/rancher-windows-386-${cli_version}.zip}"
}
...
master()
{
    ...
    export CATTLE_RANCHER_COMPOSE_VERSION ${CATTLE_RANCHER_COMPOSE_VERSION:-v0.12.5}
    export DEFAULT_CATTLE_RANCHER_COMPOSE_LINUX_URL=${artifact_base}/compose/${CATTLE_RANCHER_COMPOSE_VERSION}/rancher-compose-linux-amd64-${CATTLE_RANCHER_COMPOSE_VERSION}.tar.gz
    export DEFAULT_CATTLE_RANCHER_COMPOSE_DARWIN_URL=${artifact_base}/compose/${CATTLE_RANCHER_COMPOSE_VERSION}/rancher-compose-darwin-amd64-${CATTLE_RANCHER_COMPOSE_VERSION}.tar.gz
    export DEFAULT_CATTLE_RANCHER_COMPOSE_WINDOWS_URL=${artifact_base}/compose/${CATTLE_RANCHER_COMPOSE_VERSION}/rancher-compose-windows-386-${CATTLE_RANCHER_COMPOSE_VERSION}.zip
    export CATTLE_RANCHER_CLI_VERSION ${CATTLE_RANCHER_CLI_VERSION:-v0.6.14}
    export DEFAULT_CATTLE_RANCHER_CLI_LINUX_URL=${artifact_base}/cli/${CATTLE_RANCHER_CLI_VERSION}/rancher-linux-amd64-${CATTLE_RANCHER_CLI_VERSION}.tar.gz
    export DEFAULT_CATTLE_RANCHER_CLI_DARWIN_URL=${artifact_base}/cli/${CATTLE_RANCHER_CLI_VERSION}/rancher-darwin-amd64-${CATTLE_RANCHER_CLI_VERSION}.tar.gz
    export DEFAULT_CATTLE_RANCHER_CLI_WINDOWS_URL=${artifact_base}/cli/${CATTLE_RANCHER_CLI_VERSION}/rancher-windows-386-${CATTLE_RANCHER_CLI_VERSION}.zip
