...
image=${IMAGE:-pasturestack-validation/server:v1.6.433}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.433 \
    ...
    'DEFAULT_CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"cc549542d10565b74034c58e5f2fe3dba8eaab71"}}}' \
    'CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"cc549542d10565b74034c58e5f2fe3dba8eaab71"}}}'; do
