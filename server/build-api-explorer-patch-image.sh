...
orchestration_engine_artifact_sha256=${ORCHESTRATION_ENGINE_ARTIFACT_SHA256:-f06f1ebff2457f87f93402562007fcb29cd34d5afc00d15940c4a2e63947166e}
orchestration_engine_commit=${ORCHESTRATION_ENGINE_COMMIT:-6c7922b492b45eccb28e46fe485864104a9ed075}
...
web_console_release_tag=${WEB_CONSOLE_RELEASE_TAG:-1.6.105}
web_console_artifact=${WEB_CONSOLE_ARTIFACT:-web-console-1.6.105.tar.gz}
web_console_artifact_sha256=${WEB_CONSOLE_ARTIFACT_SHA256:-f2bbdafd98e8a9287584a9fe9dc0b4e3d8c66481425b39010c37b200681b3faa}
web_console_commit=${WEB_CONSOLE_COMMIT:-1aae2b75ae2ae99845c55bde79336d36f9f8b5f0}
...
image=${IMAGE:-pasturestack-validation/server:v1.6.415}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.415 \
...
docker run --rm --entrypoint bash "$image" -lc '
    ...
    resources_jar=$(find "${web_root}/WEB-INF/lib" -maxdepth 1 -type f \
        -name "cattle-resources-0.183.295.jar" -print -quit)
