...
image=${IMAGE:-pasturestack-validation/server:v1.6.437}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.437 \
    ...
    'DEFAULT_CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"9d487b1cf3681e6718058b456d218b7742d7b96b"}}}' \
    'CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"9d487b1cf3681e6718058b456d218b7742d7b96b"}}}'; do
