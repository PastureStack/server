...
image=${IMAGE:-pasturestack-validation/server:v1.6.434}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.434 \
    ...
    'DEFAULT_CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"b0a36559e91a539c87fd38bae663c4b41a112fcf"}}}' \
    'CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"b0a36559e91a539c87fd38bae663c4b41a112fcf"}}}'; do
