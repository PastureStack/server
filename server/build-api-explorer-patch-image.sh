...
orchestration_engine_release_tag=${ORCHESTRATION_ENGINE_RELEASE_TAG:-v0.183.319}
orchestration_engine_artifact=${ORCHESTRATION_ENGINE_ARTIFACT:-orchestration-engine-0.183.319.jar}
orchestration_engine_artifact_sha256=${ORCHESTRATION_ENGINE_ARTIFACT_SHA256:-74ac55939399873eeb9ab0813ca193e373ccf2bdde3e3d884d5491b4d0b7608e}
orchestration_engine_commit=${ORCHESTRATION_ENGINE_COMMIT:-222552c4b1fad095a5b55756cdca8e02b088ba04}
...
web_console_release_tag=${WEB_CONSOLE_RELEASE_TAG:-1.6.126}
web_console_artifact=${WEB_CONSOLE_ARTIFACT:-web-console-1.6.126.tar.gz}
web_console_artifact_sha256=${WEB_CONSOLE_ARTIFACT_SHA256:-a278904a10ce757510ed516507bd3926b02bab42a52a27bd153ff5e94e2998aa}
web_console_commit=${WEB_CONSOLE_COMMIT:-5cba85d3ab954c416b86910f760f987ec2bfc526}
...
image=${IMAGE:-pasturestack-validation/server:v1.6.462}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.462 \
    CATTLE_API_UI_VERSION=1.1.18 \
    CATTLE_CATTLE_VERSION=v0.183.319 \
...
docker run --rm --entrypoint bash "$image" -lc '
    ...
    resources_jar=$(find "${web_root}/WEB-INF/lib" -maxdepth 1 -type f \
        -name "cattle-resources-0.183.319.jar" -print -quit)
...
docker run --rm --entrypoint bash "$image" -lc '
    ...
    unzip -p /usr/share/cattle/cattle.jar META-INF/MANIFEST.MF |
        tr -d "\r" |
        grep -Fx "Implementation-Version: 0.183.319" >/dev/null
