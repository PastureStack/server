...
web_console_release_tag=${WEB_CONSOLE_RELEASE_TAG:-1.6.108}
web_console_artifact=${WEB_CONSOLE_ARTIFACT:-web-console-1.6.108.tar.gz}
web_console_artifact_sha256=${WEB_CONSOLE_ARTIFACT_SHA256:-a45a75bdaab37155b2bcac8ecd5a5e5abd13e64ca631f96b93a144608f98c180}
web_console_commit=${WEB_CONSOLE_COMMIT:-862f55818b43e9bbdbc3366c7fe8d763765b9a2f}
...
image=${IMAGE:-pasturestack-validation/server:v1.6.418}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.418 \
