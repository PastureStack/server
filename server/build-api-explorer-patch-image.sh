...
image=${IMAGE:-pasturestack-validation/server:v1.6.436}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.436 \
    ...
    'DEFAULT_CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"4adf274d699a2f4e729f64a951a5846523e19acc"}}}' \
    'CATTLE_CATALOG_URL={"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"4adf274d699a2f4e729f64a951a5846523e19acc"}}}'; do
