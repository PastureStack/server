...
image=${IMAGE:-pasturestack-validation/server:v1.6.290}
catalog_commit=bb38a5dacb1235e0aec88083aeaa0553a94710f7
...
test "$(grep -Fxc "CATTLE_RANCHER_SERVER_VERSION=v1.6.290" \
    <<<"$image_environment")" = 1
