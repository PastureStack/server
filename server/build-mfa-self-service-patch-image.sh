...
web_console_release_tag=${WEB_CONSOLE_RELEASE_TAG:-v1.6.56-pasturestack.30}
web_console_artifact=${WEB_CONSOLE_ARTIFACT:-web-console-1.6.56-pasturestack.30.tar.gz}
...
image=${IMAGE:-pasturestack-validation/server:v1.6.318}
build_options=()
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.318 \
    ...
    PASTURESTACK_WEB_CONSOLE_PACKAGE=1.6.56-pasturestack.30 \
