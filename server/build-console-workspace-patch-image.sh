...
web_console_release_tag=${WEB_CONSOLE_RELEASE_TAG:-v1.6.56-pasturestack.11}
web_console_artifact=${WEB_CONSOLE_ARTIFACT:-web-console-1.6.56-pasturestack.11.tar.gz}
...
image=${IMAGE:-pasturestack-validation/server:v1.6.299}
...
for marker in \
    CATTLE_RANCHER_SERVER_VERSION=v1.6.299 \
    ...
    PASTURESTACK_WEB_CONSOLE_PACKAGE=1.6.56-pasturestack.11 \
