...
run_gate catalog_first_party_localization scripts/check-server-catalog-first-party-localization-patch.sh
run_gate catalog_card_brand scripts/check-server-catalog-card-brand-patch.sh
...
run_gate console_workspace_patch scripts/check-server-console-workspace-patch.sh
run_gate docker_host_support_patch scripts/check-server-docker-host-support-patch.sh
run_gate container_metrics_ui_patch scripts/check-server-container-metrics-ui-patch.sh
run_gate storage_bulk_remove_ui_patch scripts/check-server-storage-bulk-remove-ui-patch.sh
run_gate openid_connect_patch scripts/check-server-openid-connect-patch.sh
run_gate oidc_api_host_patch scripts/check-server-oidc-api-host-patch.sh
...
run_gate port_preflight_runtime_patch scripts/check-server-port-preflight-runtime-patch.sh
