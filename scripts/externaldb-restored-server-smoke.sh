...
server_image="${SERVER_IMAGE:-ghcr.io/pasturestack/server-externaldb:v1.6.276}"
...
Options:
  ...
  --server-image IMAGE   External-DB PastureStack Server image. Default ghcr.io/pasturestack/server-externaldb:v1.6.276.
