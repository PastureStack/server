...
require_marker server/patches/bootstrap.sh 'local platform_home="${PASTURESTACK_HOME:-${CATTLE_HOME}}"' SERVER_BOOTSTRAP_PLATFORM_HOME_MISSING
require_marker server/patches/bootstrap.sh 'local main="${platform_home}/node-agent/apply.sh"' SERVER_BOOTSTRAP_NODE_AGENT_ENTRYPOINT_MISSING
require_marker server/patches/bootstrap.sh 'main="${CATTLE_HOME}/pyagent/apply.sh"' SERVER_BOOTSTRAP_LEGACY_AGENT_ENTRYPOINT_FALLBACK_MISSING
require_marker server/patches/bootstrap.sh 'error "No installed node-agent entrypoint was found"' SERVER_BOOTSTRAP_AGENT_ENTRYPOINT_FAIL_CLOSED_MISSING
require_marker server/patches/bootstrap.sh 'exec "$main" start' SERVER_BOOTSTRAP_AGENT_ENTRYPOINT_UNQUOTED
reject_marker server/patches/bootstrap.sh 'eval "$LINE"' SERVER_BOOTSTRAP_READ_ENV_EVAL
reject_marker server/patches/bootstrap.sh 'local main=${CATTLE_HOME}/pyagent/apply.sh' SERVER_BOOTSTRAP_LEGACY_AGENT_ENTRYPOINT_PRIMARY
