...
APPROVED_CATALOG_COMMIT="d660aac76131a40f0c907c03133f7920e8ffbd9c"
...
resolve_release_tag() {
    ...
    APPROVED_COMPOSE_LINUX_URL="${RELEASE_BASE_URL}/compose-cli-0.14.30-linux-amd64.tar.gz"
    APPROVED_COMPOSE_DARWIN_URL="${RELEASE_BASE_URL}/compose-cli-0.14.30-darwin-amd64.tar.gz"
    APPROVED_COMPOSE_WINDOWS_URL="${RELEASE_BASE_URL}/compose-cli-0.14.30-windows-amd64.zip"
}
...
verify_database() {
    ...
    [ "$approved_settings" = 12 ] ||
        die "expected 12 approved persisted coordinates, found $approved_settings"
