...
APPROVED_LB_IMAGE="ghcr.io/pasturestack/load-balancer-service:v0.9.27"
APPROVED_LB_DIGEST="sha256:22b0921a5a92b41f004a0369ad76d8771feb2de5f47bd712ef0aa3c82f43f614"
...
APPROVED_CATALOG_COMMIT="18cc041a293a2760fab23e31cc832be1d2084a27"
...
apply_database_changes() {
    ...
    db_query "
        ...
        -- Keep commit at the last successfully indexed revision. Catalog
        -- Service detects the commit/pinned_commit mismatch, rebuilds the
        -- template index, and advances commit only after that succeeds.
        UPDATE catalog
