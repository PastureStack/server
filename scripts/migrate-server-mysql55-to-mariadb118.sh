...
resolve_catalog_json() {
    ...
    CATALOG_JSON='{"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"1a24b6759f02b800a0a8ad149bb4d4d8afb58722"}}}'
    validate_catalog_json
