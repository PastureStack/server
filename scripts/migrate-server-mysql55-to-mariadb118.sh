...
NEW_IMAGE="${NEW_IMAGE:-ghcr.io/pasturestack/server:v1.6.271}"
...
RC16_ARTIFACT_BASE_URL="${RC16_ARTIFACT_BASE_URL:-https://github.com/PastureStack/server/releases/download/v1.6.271}"
...
resolve_catalog_json() {
    ...
    CATALOG_JSON='{"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"c2fecf2c884cef394a79f041f9081908c1bbe55e"}}}'
    validate_catalog_json
