...
NEW_IMAGE="${NEW_IMAGE:-ghcr.io/pasturestack/server:v1.6.270}"
...
RC16_ARTIFACT_BASE_URL="${RC16_ARTIFACT_BASE_URL:-https://github.com/PastureStack/server/releases/download/v1.6.270}"
