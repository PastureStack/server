...
NEW_IMAGE="${NEW_IMAGE:-ghcr.io/pasturestack/server:v1.6.287}"
...
RC16_LB_INSTANCE_IMAGE="${RC16_LB_INSTANCE_IMAGE:-ghcr.io/pasturestack/load-balancer-service:v0.9.27}"
...
resolve_catalog_json() {
    ...
    CATALOG_JSON='{"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"18cc041a293a2760fab23e31cc832be1d2084a27"}}}'
    validate_catalog_json
