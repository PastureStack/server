...
resolve_catalog_json() {
    ...
    CATALOG_JSON='{"catalogs":{"pasturestack":{"url":"https://github.com/PastureStack/catalog-templates.git","branch":"main","pinnedCommit":"3cfb447d7564cf9bada4bac2e15ce3dd6b221615"}}}'
    validate_catalog_json
