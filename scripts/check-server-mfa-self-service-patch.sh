...
release_doc=docs/releases/server-1.6.318.md
...
require_marker "$dockerfile" \
    'org.opencontainers.image.version="v1.6.318"' \
...
require_marker "$dockerfile" \
    'ENV PASTURESTACK_WEB_CONSOLE_PACKAGE=1.6.56-pasturestack.30' \
...
printf 'SERVER_MFA_SELF_SERVICE_PATCH_OK release=v1.6.318 engine=0.183.271 authentication_service=0.2.4 web_console=1.6.56-pasturestack.30 base=v1.6.316 locales=13 runtime_digest_coordinates=0\n'
