...
release_notes=docs/releases/server-1.6.433.md
...
require_marker "$release_dockerfile" \
    'org.opencontainers.image.version="v1.6.433"' \
...
require_marker "$release_dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.433' \
...
require_marker "$release_dockerfile" \
    'ENV PASTURESTACK_CATALOG_COMMIT=cc549542d10565b74034c58e5f2fe3dba8eaab71' \
    SERVER_CATALOG_VERSION_LABEL_COMMIT_MISSING
require_marker "$release_dockerfile" \
    '"pinnedCommit":"cc549542d10565b74034c58e5f2fe3dba8eaab71"' \
    SERVER_CATALOG_VERSION_LABEL_URL_MISSING
require_marker "$build_script" \
    'PASTURESTACK_CATALOG_COMMIT=cc549542d10565b74034c58e5f2fe3dba8eaab71' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.433"
...
bash "$vendor_pending_validator" "$runtime_vendor_pending" \
    "$vendor_pending_fixture" v1.6.433 >/dev/null
