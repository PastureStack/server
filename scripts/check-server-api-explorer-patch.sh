...
release_notes=docs/releases/server-1.6.427.md
...
require_marker "$release_dockerfile" \
    'org.opencontainers.image.version="v1.6.427"' \
...
require_marker "$release_dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.427' \
...
for release_engine_marker in \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.297' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.297.jar' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=22d126442aab342f6f94d88fc3706c50008d1e437ce86cea8f32dda81c896fb7' \
    'ARG ORCHESTRATION_ENGINE_COMMIT=9beb27e228d65dc89166f681b81478addbcfc887' \
    'COPY --from=release_artifacts /out/orchestration-engine.jar /tmp/orchestration-engine.jar' \
    "grep -Fx 'Implementation-Version: 0.183.297'" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.297' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.427"
...
bash "$vendor_pending_validator" "$runtime_vendor_pending" \
    "$vendor_pending_fixture" v1.6.427 >/dev/null
