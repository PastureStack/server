...
release_notes=docs/releases/server-1.6.405.md
...
for release_engine_marker in \
    ...
    "grep -Fx 'Implementation-Version: 0.183.291'" \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.405"
