...
ARG CATALOG_SERVICE_VERSION=0.20.10|SERVER_CATALOG_SERVICE_VERSION_MISSING
ARG CATALOG_SERVICE_BINARY_SHA256=9e4aef36c7ead2ff039d96121f6145fc68b34ad70ef030fd09d3446819dd4c84|SERVER_CATALOG_SERVICE_HASH_MISSING
...
printf 'SERVER_API_EXPLORER_PATCH_OK release=v1.6.359 base=v1.6.358 api_explorer=1.1.17 bootstrap=5.3.8 bootstrap_icons=1.13.1 bootstrap_javascript=0 runtime_go=1.27.0 ubuntu_security_refresh=2026-08-26 runtime_digest_coordinates=1 legal_assets=complete\n'
