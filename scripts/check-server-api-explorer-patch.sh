...
release_notes=docs/releases/server-1.6.406.md
...
require_marker "$release_dockerfile" \
    'org.opencontainers.image.version="v1.6.406"' \
...
require_marker "$release_dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.406' \
...
for release_engine_marker in \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.292' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.292.jar' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=57362214e72f611b45d0b3a878aeb017282ddc766cf59abc3e5f487714b9a79e' \
    'ARG ORCHESTRATION_ENGINE_COMMIT=63d2d63a2036f569010daaaed701307b1c4f20a5' \
    'COPY --from=release_artifacts /out/orchestration-engine.jar /tmp/orchestration-engine.jar' \
    "grep -Fx 'Implementation-Version: 0.183.292'" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.292' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.406"
