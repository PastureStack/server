...
release_notes=docs/releases/server-1.6.403.md
...
require_marker "$release_dockerfile" \
    'org.opencontainers.image.version="v1.6.403"' \
...
require_marker "$release_dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.403' \
...
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.289' \
    SERVER_ORCHESTRATION_RELEASE_TAG_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.289.jar' \
    SERVER_ORCHESTRATION_RELEASE_ARTIFACT_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=eed36714f4d5ac6841f172562d71a9ee7a93e2e43b4d212bb1d109bd77d0a5ec' \
    SERVER_ORCHESTRATION_RELEASE_HASH_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_COMMIT=60e97127ba49ab0b14f8bd872688257b1478aa98' \
    SERVER_ORCHESTRATION_RELEASE_COMMIT_MISSING
require_marker "$dockerfile" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.289' \
    SERVER_ORCHESTRATION_RUNTIME_VERSION_MISSING
require_marker "$dockerfile" \
    'grep -Fx '\''Implementation-Version: 0.183.289'\'' >/dev/null' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.403"
