...
release_notes=docs/releases/server-1.6.435.md
...
require_marker "$release_dockerfile" \
    'org.opencontainers.image.version="v1.6.435"' \
...
require_marker "$release_dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.435' \
...
require_marker "$release_dockerfile" \
    'ENV PASTURESTACK_CATALOG_COMMIT=ae8a8ce45e1537756ec6f55dd93f2acec1c15e98' \
    SERVER_CATALOG_VERSION_LABEL_COMMIT_MISSING
require_marker "$release_dockerfile" \
    '"pinnedCommit":"ae8a8ce45e1537756ec6f55dd93f2acec1c15e98"' \
    SERVER_CATALOG_VERSION_LABEL_URL_MISSING
require_marker "$build_script" \
    'PASTURESTACK_CATALOG_COMMIT=ae8a8ce45e1537756ec6f55dd93f2acec1c15e98' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.435"
...
bash "$vendor_pending_validator" "$runtime_vendor_pending" \
    "$vendor_pending_fixture" v1.6.435 >/dev/null
