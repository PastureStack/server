...
for release_engine_marker in \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.306' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.306.jar' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=101602f153271632caac133dd2b695f7903c0e3a7e7353ce356c7ccedda9ebb4' \
    'ARG ORCHESTRATION_ENGINE_COMMIT=f96c3018d95a25390764bc586bd1dfddf761b470' \
    'COPY --from=release_artifacts /out/orchestration-engine.jar /tmp/orchestration-engine.jar' \
    "grep -Fx 'Implementation-Version: 0.183.306'" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.306' \
...
for current_release_marker in \
    ...
    '`f96c3018d95a25390764bc586bd1dfddf761b470`' \
...
for current_readme_marker in \
    '`v1.6.443` combines Orchestration Engine `0.183.306`' \
...
for current_compatibility_marker in \
    'Orchestration Engine `v0.183.306`' \
