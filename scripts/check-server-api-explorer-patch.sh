...
release_notes=docs/releases/server-1.6.390.md
...
require_marker "$dockerfile" \
    'org.opencontainers.image.version="v1.6.390"' \
    SERVER_API_EXPLORER_PATCH_VERSION_MISSING
require_marker "$dockerfile" \
    'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.390' \
...
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.288' \
    SERVER_ORCHESTRATION_RELEASE_TAG_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.288.jar' \
    SERVER_ORCHESTRATION_RELEASE_ARTIFACT_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=a68f1fea103ececd288db708f129e8cb8f47ad3b78b73102d2190d680e357247' \
    SERVER_ORCHESTRATION_RELEASE_HASH_MISSING
require_marker "$dockerfile" \
    'ARG ORCHESTRATION_ENGINE_COMMIT=a9e5d71cb5c11360018488a391c25db3f245555d' \
    SERVER_ORCHESTRATION_RELEASE_COMMIT_MISSING
require_marker "$dockerfile" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.288' \
...
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_RELEASE_TAG=1.6.93' \
    SERVER_WEB_CONSOLE_RELEASE_TAG_MISSING
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_ARTIFACT=web-console-1.6.93.tar.gz' \
    SERVER_WEB_CONSOLE_RELEASE_ARTIFACT_MISSING
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_ARTIFACT_SHA256=46917e763ba560b13fa55f2e9a6c812ec7849d8daccbbd1bb655edbdf14c48ee' \
    SERVER_WEB_CONSOLE_RELEASE_HASH_MISSING
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_COMMIT=30378c93e1fdb70404a2ad2793212b61c65e74b1' \
...
require_marker "$build_script" \
    'test "$(cat "${web_root}/VERSION.txt")" = "1.6.93"' \
...
jq -e '
  ...
  and .["@id"] == "https://github.com/PastureStack/server/security/openvex/v1.6.390"
