...
for release_engine_marker in \
    'ARG ORCHESTRATION_ENGINE_RELEASE_TAG=v0.183.307' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT=orchestration-engine-0.183.307.jar' \
    'ARG ORCHESTRATION_ENGINE_ARTIFACT_SHA256=41a1c9c32cee1c76c51c25e2381408166a7b869f244a8718c82e7d8fe8d9c782' \
    'ARG ORCHESTRATION_ENGINE_COMMIT=a058fc51fe4160496cfff4ace00b92ea32e3a281' \
    'COPY --from=release_artifacts /out/orchestration-engine.jar /tmp/orchestration-engine.jar' \
    "grep -Fx 'Implementation-Version: 0.183.307'" \
    'ENV CATTLE_CATTLE_VERSION=v0.183.307' \
...
for current_release_marker in \
    ...
    '`a058fc51fe4160496cfff4ace00b92ea32e3a281`' \
    ...
    '## Server-side compatibility guard'; do
...
for current_readme_marker in \
    '`v1.6.443` combines Orchestration Engine `0.183.307`' \
...
for current_compatibility_marker in \
    'Orchestration Engine `v0.183.307`' \
