...
printf 'SERVER_CONTAINER_METRICS_UI_PATCH_OK release=v1.6.307 web_console=1.6.56-pasturestack.18 base=v1.6.306 locales=13 runtime_digest_coordinates=0\n'
