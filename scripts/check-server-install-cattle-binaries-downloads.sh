...
agent.package.host-api-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/host-api-0.38.4.tar.gz
agent.package.python-agent-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/node-agent-0.13.21.tar.gz
agent.package.windows-agent-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/node-agent-0.13.21-windows-amd64.zip
agent.package.per-host-subnet-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/per-host-subnet-0.2.4-windows-amd64.zip
service.package.catalog-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/catalog-service-0.20.6.tar.xz,catalog-service
service.package.authentication-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/authentication-service-0.1.7-linux-amd64.tar.xz,authentication-service
service.package.compose-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/compose-executor-0.14.31-linux-amd64.gz,compose-executor
service.package.machine-bundle-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/machine-driver-bundle-0.14.0-linux-amd64.tar.xz,docker-machine
service.package.host-provisioner-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/host-provisioner-0.39.4-linux-amd64.tar.xz,host-provisioner
service.package.vsphere-cli-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/vsphere-cli-bundle-0.54.1-linux-amd64.tar.xz,govc
service.package.secret-delivery-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/secret-delivery-api-0.2.2-linux-amd64.tar.xz,secret-delivery-api
service.package.usage-telemetry-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/usage-telemetry-agent-0.4.0-pasturestack.1-linux-amd64.tar.xz,usage-telemetry-agent
service.package.webhook-automation-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/webhook-automation-service-0.9.15-pasturestack.1-linux-amd64.tar.xz,webhook-automation-service
service.package.websocket-current.url=https://github.com/PastureStack/server/releases/download/v1.6.275/websocket-proxy-0.23.12-linux-amd64.tar.xz,websocket-proxy
EOF
(
  export RC16_ARTIFACT_BASE_URL=https://artifacts.invalid/rc16
  # shellcheck source=/dev/null
