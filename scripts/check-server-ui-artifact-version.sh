...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-d660aac76131a40f0c907c03133f7920e8ffbd9c}"
...
expected_runtime_license_bundle_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.272}"
expected_runtime_license_bundle_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-238d97bea7b8d838c590d85320188529a943f25183ca8bbc08c74f07da02247f}"
