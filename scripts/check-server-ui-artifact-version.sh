...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-faa122271462c52cc6c6c7a461d9e649e232e9fa}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-15}"
...
require_marker server/Dockerfile.catalog-aws-storage-patch "ENV PASTURESTACK_CATALOG_COMMIT=${expected_catalog_commit}" SERVER_AWS_STORAGE_PATCH_CATALOG_PIN_MISSING
