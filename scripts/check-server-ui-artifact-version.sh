...
expected_runtime_license_bundle_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.270}"
expected_runtime_license_bundle_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-dbf6566fd0182e5ed35dc8dc3a292f9dcc9e0f7d1861054814b33343f42145ba}"
