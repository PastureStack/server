...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-c2fecf2c884cef394a79f041f9081908c1bbe55e}"
...
expected_compose_executor_version="${PASTURESTACK_EXPECTED_COMPOSE_EXECUTOR_VERSION:-0.14.30}"
expected_compose_executor_binary_sha256="${PASTURESTACK_EXPECTED_COMPOSE_EXECUTOR_BINARY_SHA256:-cf23479f9d3eeb1f0e8dfce61efef0abedb2054d5837a444c5a46ff7779e9ff8}"
...
expected_runtime_license_bundle_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.271}"
expected_runtime_license_bundle_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-152271f51af8c00252ce8da7fc8e1c982e46bfb9f89843d7b5aa2b0a26748036}"
...
[ "$failures" -eq 0 ]
printf 'SERVER_UI_ARTIFACT_VERSION_OK server=%s cattle=%s ui=%s api_ui=%s artifact_download_fail_closed=1 oci_labels=1 externaldb_base=1 auth_hotfix_base=1 promotion_defaults=%s helper_artifacts=1 catalog_sqlite_binary=1 vsphere_cli_bundle=1 usage_telemetry_agent=1 webhook_automation_service=1 govc_compatibility_rewrite=1 reproducible_epoch=1 zulu8_path=0\n' \
