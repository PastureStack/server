...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-1a24b6759f02b800a0a8ad149bb4d4d8afb58722}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-12}"
