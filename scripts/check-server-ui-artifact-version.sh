...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-9b5115c068d2e6dbfa1cc8ffebb01eaf0e90f171}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-13}"
...
require_marker server/Dockerfile.catalog-route53-dns-sync-patch "ENV PASTURESTACK_CATALOG_COMMIT=${expected_catalog_commit}" SERVER_ROUTE53_PATCH_CATALOG_PIN_MISSING
