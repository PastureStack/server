...
expected_lb_image="${RC16_EXPECTED_LB_IMAGE:-ghcr.io/pasturestack/load-balancer-service:v0.9.27}"
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-18cc041a293a2760fab23e31cc832be1d2084a27}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-16}"
...
expected_runtime_license_bundle_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.278}"
expected_runtime_license_bundle_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-317823d94aacb233fcc1827531bd45a4d0de54de0e75e53139bfdd7047c266e7}"
...
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*container-schedule:1' SERVER_RELEASE_CONTAINER_SCHEDULE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/container-cron:v0.6.0' SERVER_RELEASE_CONTAINER_SCHEDULE_IMAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*system-image-preloader:1' SERVER_RELEASE_SYSTEM_IMAGE_PRELOADER_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/system-image-preloader:v0.3.0' SERVER_RELEASE_SYSTEM_IMAGE_PRELOADER_IMAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*route53-dns-sync:1' SERVER_RELEASE_ROUTE53_DNS_SYNC_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/external-dns-sync:v0.8.0' SERVER_RELEASE_ROUTE53_DNS_SYNC_IMAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*amazon-ebs-storage:1' SERVER_RELEASE_AMAZON_EBS_STORAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/ebs-storage-driver:v0.10.0' SERVER_RELEASE_AMAZON_EBS_STORAGE_IMAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*amazon-efs-storage:1' SERVER_RELEASE_AMAZON_EFS_STORAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/efs-storage-driver:v0.10.0' SERVER_RELEASE_AMAZON_EFS_STORAGE_IMAGE_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'pasturestack:infra*network-diagnostics:1' SERVER_RELEASE_NETWORK_DIAGNOSTICS_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/network-diagnostics-agent:v0.2.0' SERVER_RELEASE_NETWORK_DIAGNOSTICS_AGENT_GATE_MISSING
require_marker scripts/release-server-on-github.sh 'ghcr.io/pasturestack/network-diagnostics-service:v0.2.0' SERVER_RELEASE_NETWORK_DIAGNOSTICS_SERVICE_GATE_MISSING
require_marker server/Dockerfile.catalog-route53-dns-sync-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.284' SERVER_ROUTE53_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-route53-dns-sync-patch 'org.opencontainers.image.version="v1.6.285"' SERVER_ROUTE53_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-route53-dns-sync-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.285' SERVER_ROUTE53_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-route53-dns-sync-patch 'ENV PASTURESTACK_CATALOG_COMMIT=9b5115c068d2e6dbfa1cc8ffebb01eaf0e90f171' SERVER_ROUTE53_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-route53-dns-sync-patch-image.sh 'pasturestack-validation/server:v1.6.285' SERVER_ROUTE53_PATCH_BUILD_DEFAULT_NOT_CURRENT
reject_marker server/Dockerfile.catalog-route53-dns-sync-patch '@sha256:' SERVER_ROUTE53_PATCH_OPERATIONAL_DIGEST_PRESENT
require_marker server/Dockerfile.catalog-aws-storage-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.285' SERVER_AWS_STORAGE_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-aws-storage-patch 'org.opencontainers.image.version="v1.6.286"' SERVER_AWS_STORAGE_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-aws-storage-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.286' SERVER_AWS_STORAGE_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-aws-storage-patch 'ENV PASTURESTACK_CATALOG_COMMIT=faa122271462c52cc6c6c7a461d9e649e232e9fa' SERVER_AWS_STORAGE_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-aws-storage-patch-image.sh 'pasturestack-validation/server:v1.6.286' SERVER_AWS_STORAGE_PATCH_BUILD_DEFAULT_NOT_CURRENT
reject_marker server/Dockerfile.catalog-aws-storage-patch '@sha256:' SERVER_AWS_STORAGE_PATCH_OPERATIONAL_DIGEST_PRESENT
require_marker server/Dockerfile.catalog-network-diagnostics-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.286' SERVER_NETWORK_DIAGNOSTICS_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-diagnostics-patch 'org.opencontainers.image.version="v1.6.287"' SERVER_NETWORK_DIAGNOSTICS_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-diagnostics-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.287' SERVER_NETWORK_DIAGNOSTICS_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-diagnostics-patch "ENV PASTURESTACK_CATALOG_COMMIT=${expected_catalog_commit}" SERVER_NETWORK_DIAGNOSTICS_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-network-diagnostics-patch-image.sh 'pasturestack-validation/server:v1.6.287' SERVER_NETWORK_DIAGNOSTICS_PATCH_BUILD_DEFAULT_NOT_CURRENT
reject_marker server/Dockerfile.catalog-network-diagnostics-patch '@sha256:' SERVER_NETWORK_DIAGNOSTICS_PATCH_OPERATIONAL_DIGEST_PRESENT
require_marker server/Dockerfile.catalog-network-policy-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.287' SERVER_NETWORK_POLICY_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-policy-patch 'org.opencontainers.image.version="v1.6.288"' SERVER_NETWORK_POLICY_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-policy-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.288' SERVER_NETWORK_POLICY_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-network-policy-patch 'ENV PASTURESTACK_CATALOG_COMMIT=b3f412fb07af983553ec9c1b61f6db00de3d9742' SERVER_NETWORK_POLICY_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-network-policy-patch-image.sh 'pasturestack-validation/server:v1.6.288' SERVER_NETWORK_POLICY_PATCH_BUILD_DEFAULT_NOT_CURRENT
reject_marker server/Dockerfile.catalog-network-policy-patch '@sha256:' SERVER_NETWORK_POLICY_PATCH_OPERATIONAL_DIGEST_PRESENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.289' SERVER_SECRET_VOLUME_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'org.opencontainers.image.version="v1.6.290"' SERVER_SECRET_VOLUME_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.290' SERVER_SECRET_VOLUME_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'ENV PASTURESTACK_CATALOG_COMMIT=bb38a5dacb1235e0aec88083aeaa0553a94710f7' SERVER_SECRET_VOLUME_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-secret-volume-patch-image.sh 'pasturestack-validation/server:v1.6.290' SERVER_SECRET_VOLUME_PATCH_BUILD_DEFAULT_NOT_CURRENT
require_marker server/build-catalog-secret-volume-patch-image.sh 'catalog_commit=bb38a5dacb1235e0aec88083aeaa0553a94710f7' SERVER_SECRET_VOLUME_PATCH_BUILD_CATALOG_PIN_MISSING
reject_marker server/Dockerfile.catalog-secret-volume-patch '@sha256:' SERVER_SECRET_VOLUME_PATCH_OPERATIONAL_DIGEST_PRESENT
require_marker server/Dockerfile.catalog-vault-volume-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.290' SERVER_VAULT_VOLUME_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-vault-volume-patch 'org.opencontainers.image.version="v1.6.291"' SERVER_VAULT_VOLUME_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-vault-volume-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.291' SERVER_VAULT_VOLUME_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-vault-volume-patch 'ENV PASTURESTACK_CATALOG_COMMIT=4205e1d3b4fec7691c9e5531375f5268c80924da' SERVER_VAULT_VOLUME_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-vault-volume-patch-image.sh 'pasturestack-validation/server:v1.6.291' SERVER_VAULT_VOLUME_PATCH_BUILD_DEFAULT_NOT_CURRENT
require_marker server/build-catalog-vault-volume-patch-image.sh 'catalog_commit=4205e1d3b4fec7691c9e5531375f5268c80924da' SERVER_VAULT_VOLUME_PATCH_BUILD_CATALOG_PIN_MISSING
reject_marker server/Dockerfile.catalog-vault-volume-patch '@sha256:' SERVER_VAULT_VOLUME_PATCH_OPERATIONAL_DIGEST_PRESENT
