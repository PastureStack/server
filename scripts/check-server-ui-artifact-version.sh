...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-8e4caa289895855df9706ebf625f401da4ca2e5b}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-10}"
