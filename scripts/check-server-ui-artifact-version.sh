...
expected_catalog_commit="${PASTURESTACK_EXPECTED_CATALOG_COMMIT:-3cfb447d7564cf9bada4bac2e15ce3dd6b221615}"
expected_catalog_template_count="${PASTURESTACK_EXPECTED_CATALOG_TEMPLATE_COUNT:-11}"
