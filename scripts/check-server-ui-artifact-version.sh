...
require_marker server/Dockerfile.catalog-secret-volume-patch 'ARG BASE_IMAGE=ghcr.io/pasturestack/server:v1.6.288' SERVER_SECRET_VOLUME_PATCH_BASE_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'org.opencontainers.image.version="v1.6.289"' SERVER_SECRET_VOLUME_PATCH_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'ENV CATTLE_RANCHER_SERVER_VERSION=v1.6.289' SERVER_SECRET_VOLUME_PATCH_RUNTIME_VERSION_NOT_CURRENT
require_marker server/Dockerfile.catalog-secret-volume-patch 'ENV PASTURESTACK_CATALOG_COMMIT=3de2103927bbd7c61604428bb951af90288c20ce' SERVER_SECRET_VOLUME_PATCH_CATALOG_PIN_MISSING
require_marker server/build-catalog-secret-volume-patch-image.sh 'pasturestack-validation/server:v1.6.289' SERVER_SECRET_VOLUME_PATCH_BUILD_DEFAULT_NOT_CURRENT
require_marker server/build-catalog-secret-volume-patch-image.sh 'catalog_commit=3de2103927bbd7c61604428bb951af90288c20ce' SERVER_SECRET_VOLUME_PATCH_BUILD_CATALOG_PIN_MISSING
