...
expected_version="${PASTURESTACK_EXPECTED_COMPOSE_EXECUTOR_VERSION:-0.14.31}"
expected_artifact_sha256="${PASTURESTACK_EXPECTED_COMPOSE_EXECUTOR_ARTIFACT_SHA256:-05c74cf88bc7bdc9dfdc54aff3610e944a15b39252a0bdb0b99da3f833b33224}"
expected_binary_sha256="${PASTURESTACK_EXPECTED_COMPOSE_EXECUTOR_BINARY_SHA256:-04f6e5d165514daee28f225182ad813ca165edd8bac901e20476e8532cf656b2}"
