...
release_notes=docs/releases/server-1.6.295.md
failures=0
...
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_RELEASE_TAG=v1.6.56-pasturestack.8' \
    SERVER_CATALOG_FIRST_PARTY_UI_RELEASE_MISSING
require_marker "$dockerfile" \
    'ARG WEB_CONSOLE_ARTIFACT_SHA256=68194af9637ad0cfa3308f1a506ed06af23471fcbb2c8d0de20dc17a358b1dce' \
    SERVER_CATALOG_FIRST_PARTY_UI_SHA256_MISSING
require_marker "$dockerfile" \
    'org.opencontainers.image.version="v1.6.295"' \
    SERVER_CATALOG_FIRST_PARTY_VERSION_MISSING
require_marker "$dockerfile" \
    'ENV PASTURESTACK_WEB_CONSOLE_COMMIT=864a73e73b77ef0c060d1b9bbed872478d379538' \
...
printf 'SERVER_CATALOG_FIRST_PARTY_LOCALIZATION_PATCH_OK version=v1.6.295 catalog_templates=23 infra_first_party=22 localized_questions=171\n'
