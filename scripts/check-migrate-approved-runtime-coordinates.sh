...
require_marker 'd660aac76131a40f0c907c03133f7920e8ffbd9c' CATALOG_PIN_MISSING
require_marker 'pasturestack-cli-0.6.14-linux-amd64.tar.gz' CLI_ASSET_MISSING
require_marker 'compose-cli-0.14.30-linux-amd64.tar.gz' COMPOSE_ASSET_MISSING
