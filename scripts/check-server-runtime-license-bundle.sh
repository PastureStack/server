...
expected_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.271}"
expected_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-152271f51af8c00252ce8da7fc8e1c982e46bfb9f89843d7b5aa2b0a26748036}"
