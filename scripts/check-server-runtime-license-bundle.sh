...
expected_version="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_VERSION:-1.6.272}"
expected_sha256="${PASTURESTACK_EXPECTED_RUNTIME_LICENSE_BUNDLE_SHA256:-238d97bea7b8d838c590d85320188529a943f25183ca8bbc08c74f07da02247f}"
...
test -f "$bundle_root/embedded-asset-legal/orchestration-engine-0.183.269.jar/nested/WEB-INF/lib/hazelcast-5.7.0-pasturestack.2.jar/META-INF/NOTICE"
test -f "$bundle_root/embedded-asset-legal/orchestration-engine-0.183.269.jar/nested/WEB-INF/lib/hazelcast-5.7.0-pasturestack.2.jar/LICENSE-ClassGraph.txt"
