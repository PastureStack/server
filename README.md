...
`v1.6.453` combines Orchestration Engine `0.183.312`, Node Agent `0.13.27`,
...
```sh
docker run -d --name pasturestack-server --restart unless-stopped -p 8080:8080 ghcr.io/pasturestack/server:v1.6.453
```
...
services:
  pasturestack-server:
    image: ghcr.io/pasturestack/server:v1.6.453
