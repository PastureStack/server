...
`v1.6.433` combines Orchestration Engine `0.183.298`, Node Agent `0.13.27`,
...
`cc549542d10565b74034c58e5f2fe3dba8eaab71` (Catalog Templates
`v0.3.5`). It retains prior immutable template revisions and adds reviewed
...
```sh
docker run -d --name pasturestack-server --restart unless-stopped -p 8080:8080 ghcr.io/pasturestack/server:v1.6.433
```
...
services:
  pasturestack-server:
    image: ghcr.io/pasturestack/server:v1.6.433
